...
with open('imu_00.hex', 'rb') as f:
    while(1):
        ...
        if len(samplePoint) != 24 or eof == f.tell():
            break
        # hour minutes sec
        timestamp.append([samplePoint[0], samplePoint[3], samplePoint[2]])
